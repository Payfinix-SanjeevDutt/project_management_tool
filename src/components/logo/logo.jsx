...
export const Logo = forwardRef(
    (
        { width = 120, height = 50, disableLink = false, className, href = '/', sx, ...other },
        ref
    ) => {
        ...
        const logo = (
            <Box
                component="img"
                src="/logo/tx_svg.svg" // or `${CONFIG.site.basePath}/logo.png` if using base path
                alt="logo"
                width={width}
                height={height}
            />
            ...
            <NoSsr
                fallback={
                    <Box
                        ...
                        alt="logo"
                        sx={{
                            width: 160, // <- make this bigger than real size
                            height: 80,
                            objectFit: 'contain',
                            display: 'inline-flex',
