...
const SprintEdit = ({ issueKey, summary, issueDeatils, items, handleModalClose }) => {
    ...
    const [status, setStatus] = useState(issueDeatils || 'To Do');
    ...
    const [assignee, setAssignee] = useState(issueDeatils || 'None');
    ...
    const [reporter, setReporter] = useState(issueDeatils || 'None');
