...
// import { Box, Grid, Card,Tooltip, Typography, IconButton } from '@mui/material';
...
//               return timeStr.replace(/^(\d{1,2}):(\d{2}) ([AP]M)$/i,
//                 (match, h, m, ap) => `${parseInt(h, 10)}:${m} ${ap.toUpperCase()}`);
//             }

//             // 24-hour format (HH:mm or HH:mm:ss)
//             if (/^\d{1,2}:\d{2}(:\d{2})?$/.test(timeStr)) {
//               return dayjs(timeStr, ['HH:mm', 'HH:mm:ss']).format('h:mm A');
//             }

//             // Try generic parse
//             const time = dayjs(timeStr);
//             if (time.isValid()) return time.format('h:mm A');
...
//         const checkinTime = log?.clock_in ? formatTime(log.clock_in) : '--';
//         const checkoutTime = log?.clock_out ? formatTime(log.clock_out) : '--';
//         const totalTime = log?.total_hours || calculateTotalTime(log?.clock_in, log?.clock_out);
...
//         // const totalTime = log?.totalHours || calculateTotalTime(checkinTime, checkoutTime);
// ;
...
//             case 'Leave': return '#E6E6FA';
//             // case 'Leave': return '#FFD1DC';
...
//                                         {status === 'Leave' && (
//                                             <>
//                                                 <Tooltip title={`${leaveType}${isHalfDay ? ' (Half Day)' : ''}`} arrow placement="top">
//                                                     <Typography
//                                                         variant="body2"
//                                                         fontSize={12}
//                                                         fontWeight={500}
...
//                                                 <Tooltip title={leaveReason} arrow placement="top">
//                                                     <Typography
//                                                         variant="caption"
//                                                         fontSize={12}
//                                                         sx={{
